...
public sealed class RulesEngineService(IRuleFactory ruleFactory) : IRulesEngineService
{
    private readonly IRuleFactory _ruleFactory = ruleFactory ?? throw new ArgumentNullException(nameof(ruleFactory));
