...
public sealed class ReadApplicationService(
    ...
    IOptionsSnapshot<CacheSettings> cacheSettings) : 
        ReadMetadataBaseService<ApplicationModel, ApplicationEntity>
            (CacheKeyConstants.ApplicationList, mapper, dbContextFactory, memoryCache, cacheSettings), IReadApplicationService
{
